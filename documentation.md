...
- [Features](#features)
  ...
  - [Baseline creation and regression checks](#baseline-creation-and-regression-checks)
  - [Repository-wide profiling](#repository-wide-profiling)
  - [Trend analysis](#trend-analysis)
  - [Benchmark reproducibility](#benchmark-reproducibility)
  - [Optimizer suggestions (MVP)](#optimizer-suggestions-mvp)
  - [Local LLM setup (Ollama)](#local-llm-setup-ollama)
  - [Output modes](#output-modes)
  - [Audit history tracking](#audit-history-tracking)
  - [Project configuration (ecocodetoml)](#project-configuration-ecocodetoml)
  - [Reliability and Validation](#reliability-and-validation)
  - [CI automation prototype](#ci-automation-prototype)
  - [Schema compatibility policy](#schema-compatibility-policy)
- [Command Outputs And Interpretation](#command-outputs-and-interpretation)
  - [1) ecocode profile](#1-ecocode-profile)
  - [2) ecocode baseline create](#2-ecocode-baseline-create)
  - [3) ecocode baseline compare](#3-ecocode-baseline-compare)
  - [4) ecocode profile-repo](#4-ecocode-profile-repo)
  - [5) ecocode benchmark](#5-ecocode-benchmark)
  - [6) ecocode trend](#6-ecocode-trend)
  - [7) ecocode optimize suggest](#7-ecocode-optimize-suggest)
  - [8) ecocode optimize patch](#8-ecocode-optimize-patch)
  - [9) ecocode optimize evaluate](#9-ecocode-optimize-evaluate)
- [Repository Structure](#repository-structure)
- [Quick Start (Python Core)](#quick-start-python-core)
- [Multi-Platform and Multi-Language Strategy](#multi-platform-and-multi-language-strategy)
- [Roadmap](#roadmap)
